...
const Category: React.FC<CategoryProps> = ({ label, icon: Icon, selected }) => {
	...
	return (
		<div
			...
			} flex items-center  max-[768px]:w-[48%] max-[500px]:w-[100%] max-[500px]:justify-start justify-center max-[500px]:rounded-md gap-1 border-2 py-2 px-4 rounded-full transition- cursor-pointer`}>
			<Icon size={20} />
